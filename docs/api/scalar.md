...
<style>
  /* Remove padding do content area para que o iframe ocupe toda a área */
  ...
  .scalar-embed {
    ...
    right: 0;
    bottom: 0;
    top: 48px; /* fallback — ajustado via JS abaixo */
    z-index: 1;
    border: none;
    background: #0f0f17;
  }
...
<div class="scalar-embed" id="scalar-embed">
  <iframe
    src="../scalar-ui.html"
    title="API Reference Interativa — Plataforma de Pedidos"
    loading="lazy"
    allowfullscreen>
  </iframe>
</div>
